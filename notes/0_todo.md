...
- [x] Check direct entry
  - [x] Check adding @f directly to all possible tasks
  - [x] Check adding @+ directly to @s only and @r with and without prior @+ entries
  - [x] Check adding @- directly to @s only and @r with and without prior @- and @+ entries
  - [x] Check adding @s directly to reminders without an @s entry
- [x] Modify finalize_record? to expand @+ and @- entries

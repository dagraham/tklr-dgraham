...
Recording a <em>jot</em> in <em>inbox.txt</em> is a special case. Instead of being recorded as a <em>draft</em> it will be recorded without the <code>?</code> prefix and with the timestamp automatically appended. It will thus be listed in <em>Jots View</em> but not as a "draft" in <em>Agenda View</em>. 
